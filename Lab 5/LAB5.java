...
class Student{
    ...
    String Class;
    String Department;
    Student(String regno,String name,String email,String phone,String clas,String department){
        this.Regno=regno;
        this.Name=name;
        this.Email=email;
        this.Phone=phone;
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            switch(choice){
                ...
                System.out.print("Enter the clas you enrolled :");
